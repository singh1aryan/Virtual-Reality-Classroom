...
public class GVRVideoPlayerObject12 extends GVRSceneObject{

    private final GVRVideoSceneObjectPlayer<?> mPlayer;
    private final MediaPlayer mMediaPlayer;

    public GVRVideoPlayerObject12(GVRContext gvrContext) throws IOException {
        super(gvrContext);
...
//        gvrContext.getMainScene().addSceneObject(dinoObj);
        ...
        video.setName("0");
        video.getTransform().setPosition(10,-5,-15);
