...
public class GVRVideoPlayerObject18 extends GVRSceneObject{

    private final GVRVideoSceneObjectPlayer<?> mPlayer;
    private final MediaPlayer mMediaPlayer;

    public GVRVideoPlayerObject18(GVRContext gvrContext) throws IOException {
        super(gvrContext);
...
//        gvrContext.getMainScene().addSceneObject(dinoObj);
        ...
        video.setName("0");
        video.getTransform().setPosition(-20,-5,-15);
